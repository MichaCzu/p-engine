...
//#define SHADERS_ON
const std::string ENGINE_VERSION = "1.1.0";
const std::wstring GAME_VERSION = L"0.0.0";
const char DEFAULT_WIN_TITLE[] = "The Shattered Worlds";
...
const float DEFAULT_FRAMERATE = 144; // set 0 for infinity
